...
class NBodySimulation {
  ...
  public:
    ...
    template <int _NDIM, class _T>
    friend void output_density_slices(NBodySimulation<_NDIM, _T> & sim, double redshift, std::string snapshot_folder, int nmesh);
    // Free all memory
    void free();
};
...
void NBodySimulation<NDIM, T>::analyze_and_output(int ioutput, double redshift) {
    ...
    // Density slices
    //=============================================================
    bool density_slices = false;
    int nmesh_density_slices = 128;
    if (density_slices) {
        output_density_slices(*this, redshift, snapshot_folder, nmesh_density_slices);
    }
    //=============================================================
    // Power-spectrum multipoles
    //=============================================================
