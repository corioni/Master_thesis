...
-- Path to the input                                         
ic_input_filename = "/uio/hume/student-u24/martacor/Simulation/FML/FML/COLASolver/input_Sim/mu0_trial/class_transferinfo_Sim2_GR.txt"         
