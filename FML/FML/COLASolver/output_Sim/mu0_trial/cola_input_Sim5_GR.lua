...
if gravity_model == "Marta" then                           
 -- Parameter mu0, for GR = 0.0                              
  gravity_model_marta_mu0 = -0.06551724137931034                                
end                                                          
...
-- Path to the input                                         
ic_input_filename = "/uio/hume/student-u24/martacor/Simulation/FML/FML/COLASolver/input_Sim/mu0_trial/class_transferinfo_Sim5_GR.txt"         
